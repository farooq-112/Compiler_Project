    ...
    class Constant{
       public static string[] dataTypes = {"int", "long", "float", "double", "char", "String"};
        public static string[] keywords = {" : ", " , ", "func", "return", "final", "void", "switch","continue","default","try","catch","static","self","if","else","case","main","let","var","init","throw","is","for","while","typealiase","for"};
